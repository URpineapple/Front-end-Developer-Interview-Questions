...
```
  ...
  The reason that it exists is becuase the one same-origin policy in the computing prevents a malicious script on one page from obtaining access to sensitive data on another web page through that page's Document Object Model.
```
